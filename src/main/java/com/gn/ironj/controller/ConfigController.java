...
public class ConfigController implements Serializable {
    ...
    private ConfigFacade getFacade() {
        return ejbFacade;
    }
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Config").getString("ConfigCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Config").getString("ConfigUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Config").getString("ConfigDeleted"));
        if (!JsfUtil.isValidationFailed()) {
        ...
        if (selected != null) {
            ...
            try {
                ...
                if (msg.length() > 0) {
                    ...
                    JsfUtil.addErrorMessage(ex, ResourceBundle.getBundle("/Config").getString("PersistenceErrorOccured"));
                }
            } catch (Exception ex) {
    ...
    public List<Config> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class ConfigControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            ConfigController controller = (ConfigController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "configController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Config) {
                ...
                return getStringKey(o.getPropertyKey());
            } else {
